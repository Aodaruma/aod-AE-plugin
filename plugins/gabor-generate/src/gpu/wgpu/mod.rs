...
pub struct WgpuRenderParams {
    ...
    pub frequency: f32,
    pub isotropy: f32,
    pub orientation_2d: f32,
    pub orientation_azimuth: f32,
    pub orientation_elevation: f32,
    pub slice_w: f32,
    pub slice_scale: f32,
    pub offset_x: f32,
    pub offset_y: f32,
    ...
    pub fn render(&self, params: &WgpuRenderParams) -> Result<WgpuOutput, ae::Error> {
        ...
        let uniform = Params {
            ...
            core: [
                ...
                params.frequency,
                params.isotropy,
                params.orientation_2d,
            ],
            orient: [
                params.orientation_azimuth,
                params.orientation_elevation,
                params.slice_w,
                params.slice_scale,
            ],
            misc: [params.offset_x, params.offset_y, params.gain, params.bias],
        };
        self.queue
            .write_buffer(&res.params_buf, 0, bytemuck::bytes_of(&uniform));
        ...
        let out_len = (params.out_w as usize)
